...
function completeHandler(event:LoaderEvent):void {
	...
	Debug.log("first link url: " + xml.links[0].link[0].&#64;url); //traces "first link url: http://www.greensock.com"
}
</listing>
 * 
 ...
 * Example AS3 code:<listing version="3.0">
 ...
 function completeHandler(event:LoaderEvent):void {
 	Debug.log("load complete. XML content: " + LoaderMax.getContent("xmlDoc"));
