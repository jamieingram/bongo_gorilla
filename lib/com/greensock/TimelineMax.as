...
tl.add( myTimeline.tweenFromTo("myLabel2", 0) );
		 ...
		 * For example, to loop through all the labels in order and Debug.log() them to the screen (or console.log() in JavaScript):
		 * 
		 * <listing version="3.0">
var labels = myTimeline.getLabelsArray();
for (var i = 0; i &lt; labels.length; i++) {
	Debug.log("label name: " + labels[i].name + ", time: " + labels[i].time); //or in JS, console.log("label name: " + labels[i].name + ", time: " + labels[i].time);
}
</listing>
