...
addChild(myCircle);
		 ...
		 * <listing version="3.0">
myPath.progress = 2.1;
Debug.log(myPath.progress); //traces "0.1"
Debug.log(myPath.rawProgress); //traces "2.1"
</listing>
		 * 
		 ...
		 * property in Flash where setting it to 270 works fine but when you Debug.log() the rotation value it will report 
